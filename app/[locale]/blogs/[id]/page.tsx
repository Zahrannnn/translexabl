        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              {error ? t('error.loadFailed') : t('notFound.description')}
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              ...
              <Link href="/blogs" className="hover:text-primary transition-colors">{t('breadcrumb.blog')}</Link>
              <ChevronRight className="h-4 w-4" />
        ...
        <section className="py-16 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">{t('relatedArticles.title')}</h2>
              <p className="text-muted-foreground text-lg">
                {t('relatedArticles.description', { category: post.category })}
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm text-muted-foreground">
                {t('published')} {formatDate(post.publishedAt || post.updatedAt)}
              </p>
            </div>
          </div>
        </div>
